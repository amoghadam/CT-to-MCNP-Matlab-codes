...
% 
% catheter_positionx=0;
% catheter_positiony=0;
% catheter_positionz=0;
AAxdim=0.2;
AAydim=0.2;
AAzdim=0.2;
...
if presenceof2
fprintf(fid,['si5   L   ',num2str(Ncatheter_positionx),' ',num2str(Ncatheter_positiony+0.5  ),' ',num2str(Ncatheter_positionz+source2_rel_pos),'    $   center   of   the   source   2\n']);
end
if presenceof4
